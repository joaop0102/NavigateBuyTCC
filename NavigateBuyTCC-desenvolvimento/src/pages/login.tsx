...
const Login = () => {
  ...
  return (
    <header className="flex flex-col md:flex-row h-screen">
      <Head>
        <title>Login - Navigate Buy</title>
      </Head>
        ...
        <div className="max-w-6xl mx-auto p-8">
          ...
          <form className="space-y-10 w-full max-w-lg mx-auto" onSubmit={handleSubmit}>
            ...
            <div className="text-center">
              ...
              className='mt-4 block text-sm text-[#0E023B] hover:underline'>
                Esqueci minha senha
              </a>
            </div>
            {message && (
      ...
      <div className="w-full md:w-1/2 h-full overflow-hidden bg-black bg-no-repeat flex items-center justify-center relative header-black">
        ...
        <div className="text-white p-6 sm:p-8 md:p-10 lg:p-12 max-w-md">
          ...
          <Link href="/cadastro">
            <button className="mt-12 py-3 sm:py-4 md:py-5 lg:py-6 px-8 sm:px-10 md:px-12 lg:px-20 text-base sm:text-lg md:text-xl 
            lg:text-2xl rounded-full border-2 bg-transparent text-white font-semibold border-white transition duration-1000 ease-in-out
             hover:bg-white hover:text-black hover:border-transparent btn-ajuste">
              Cadastre-se
            </button>
          </Link>
        </div>
